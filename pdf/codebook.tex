...
\IncludeCpp{Dark Magic}{ext_pbds.cpp}
...
\IncludeCpp{Binary Search On Segtree}{binary_search_on_segtree.cpp}
...
\renewcommand\Prefix{../codes/Matching_and_Flow/}

\IncludeCpp{HopcroftKarp}{Bi_Pair_Fast.cpp}
...
\IncludeCpp{Z value}{Z_Value.cpp}
\IncludeCpp{Manacher}{Manacher.cpp}
\IncludeCpp{Lexico Smallest Rotation}{smallest_rotation.cpp}
\IncludeCpp{Main Lorentz}{MainLorentz.cpp}
\IncludeCpp{BWT}{BWT.cpp}
\IncludeCpp{Palindromic Tree}{palindromic_tree.cpp}
...
\IncludeCpp{Tree Knapsack}{tree_knapsack.cpp}
